...
#' Get Japan's Consumer Price Index from World Bank
#'
#' @description
...
#'
#' @export
get_japan_cpi <- function() {
  url <- "https://api.worldbank.org/v2/country/JPN/indicator/FP.CPI.TOTL?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
