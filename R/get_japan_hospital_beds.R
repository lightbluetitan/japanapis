...
#' Get Hospital Beds per 1,000 People in Japan from World Bank
#'
#' @description
...
#'
#' @export
get_japan_hospital_beds <- function() {
  url <- "https://api.worldbank.org/v2/country/JPN/indicator/SH.MED.BEDS.ZS?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
