...
#' Get Japan's Literacy Rate (Age 15+) from World Bank
#'
#' @description
...
#'
#' @export
get_japan_literacy_rate <- function() {
  url <- "https://api.worldbank.org/v2/country/JPN/indicator/SE.ADT.LITR.ZS?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
