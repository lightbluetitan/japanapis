...
#' Get Japan's Energy Use (kg of oil equivalent per capita) from World Bank
#'
#' @description
...
#'
#' @export
get_japan_energy_use <- function() {
  url <- "https://api.worldbank.org/v2/country/JPN/indicator/EG.USE.PCAP.KG.OE?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
