...
#' Get Japan's GDP (Current US$) from World Bank
#'
#' @description
...
#'
#' @export
get_japan_gdp <- function() {
  url <- "https://api.worldbank.org/v2/country/JPN/indicator/NY.GDP.MKTP.CD?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
